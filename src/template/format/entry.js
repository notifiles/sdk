    ...
    return {
      ...
      buildPaths: {
        email: {
          ...
          assetsContainer: `${path}/.build/email/${code}/assets`,
          assetsContainerRemote: `${entry.slug}/email/${code}/assets`,
        ...
        textMessage: {
          ...
          assetsContainer: `${path}/.build/textmessage/${code}/assets`,
          assetsContainerRemote: `${entry.slug}/textmessage/${code}/assets`,
        ...
        pushNotification: {
          ...
          assetsContainer: `${path}/.build/pushnotification/${code}/assets`,
          assetsContainerRemote: `${entry.slug}/pushnotification/${code}/assets`,
